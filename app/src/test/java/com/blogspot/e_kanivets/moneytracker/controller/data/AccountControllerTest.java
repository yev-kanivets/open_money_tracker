...
public class AccountControllerTest {
    ...
    public void testRecordAdded() throws Exception {
        ...
        Account account = new Account(1, "a1", 100, "NON");
        repo.create(account);
    ...
    public void testTransferDone() throws Exception {
        Account account1 = new Account(1, "a1", 100, "NON");
        Account account2 = new Account(2, "a2", 0, "NON");
        ...
        Transfer transfer = new Transfer(1, 1, account1.getId(), account2.getId(), 10, 10);
        accountController.transferDone(transfer);
        assertEquals(90, account1.getCurSum());
        assertEquals(10, account2.getCurSum());

        transfer = new Transfer(2, 1, account1.getId(), account2.getId(), 10, 10);
        accountController.transferDone(transfer);
        assertEquals(80, account1.getCurSum());
        assertEquals(20, account2.getCurSum());

        transfer = new Transfer(2, 1, account2.getId(), account1.getId(), 20, 20);
        accountController.transferDone(transfer);
        assertEquals(100, account1.getCurSum());
        assertEquals(0, account2.getCurSum());

        transfer = new Transfer(2, 1, account1.getId(), account2.getId(), 0, 100);
        accountController.transferDone(transfer);
        assertEquals(100, account1.getCurSum());
